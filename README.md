...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nfmplji.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nfmplji.containers.anotherwebservice.com/
...
```
git clone git@github.com:bruce845/container-nfmplji.git
cd container-nfmplji
```
...
```
docker attach container-nfmplji
```
